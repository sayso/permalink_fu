class String
  # See: http://stuffofinterest.com/misc/utf8-about.html
  # Translate accented utf8 characters over to non-accented
    ...
    "\xC3\xBD" => "y", "\xC3\xBE" => "p", "\xC3\xBF" => "y", "\xC4\x80" => "A",
    "\xC4\x81" => "a", "\xC4\x82" => "A", "\xC4\x83" => "a", "\xC4\x84" => "A",
    "\xC4\x85" => "a", "\xC4\x86" => "C", "\xC4\x87" => "c", "\xC4\x88" => "C",
    "\xC4\x89" => "c", "\xC4\x8A" => "C", "\xC4\x8B" => "c", "\xC4\x8C" => "C",
    "\xC4\x8D" => "c", "\xC4\x8E" => "D", "\xC4\x8F" => "d", "\xC4\x90" => "D",
    "\xC4\x91" => "d", "\xC4\x92" => "E", "\xC4\x93" => "e", "\xC4\x94" => "E",
    "\xC4\x95" => "e", "\xC4\x96" => "E", "\xC4\x97" => "e", "\xC9\x99" => "e",
    ...
    "\xC7\x8D" => "A", "\xC7\x8E" => "a", "\xC7\x8F" => "I", "\xC7\x9C" => "u",
	...
	def convert_accents
    self.split('').map{|char| UTF8_ACCENTS_MAP[char] || char}.join
	end
